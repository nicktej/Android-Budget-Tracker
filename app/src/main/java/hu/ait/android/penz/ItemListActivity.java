...
public class ItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gestureObject = new GestureDetectorCompat(this, new ItemListActivity.Gesture());
    ...
    public void onBackPressed() {
        MyPreferences.sum = itemsAdapter.calculate();
        super.onBackPressed();
    }
    ...
    private void showCreateItemActivity() {
        Intent intentStart = new Intent(ItemListActivity.this,
